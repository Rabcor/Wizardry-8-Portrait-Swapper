class SLF:
    ...
    def extract_file(self, index: int, output_path: Optional[Union[bool, str]] = False) -> Optional[bytes]: # Accepts file index, and bool or string, True bool saves as original file-name, string is manual save path.
